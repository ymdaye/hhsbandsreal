  ...
  const resources = [
    {
      ...
      description: "Video recordings of routines and choreography",
      icon: VideoCameraIcon,
      items: [
        "Fall Show Choreography",
    ...
    {
      title: "Music Files",
      description: "Audio files for practice and performances",
      icon: MusicalNoteIcon,
      items: [
        "Fall Show Complete Recording",
        "Individual Movement Files",
        "Metronome Tracks",
        "Practice Tempos"
      ]
    },
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <section className="relative py-20 bg-gradient-to-br from-primary-600 to-primary-800">
        <div className="absolute inset-0">
          <img
            src="https://images.pexels.com/photos/7520444/pexels-photo-7520444.jpeg"
            alt="Color guard performance"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Access all your Color Guard materials, videos, music, and important information
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Contact the Color Guard director for assistance with any resources or questions.
            </p>
            
            <a
              href="mailto:aubrey.horstman@cpschools.com"
